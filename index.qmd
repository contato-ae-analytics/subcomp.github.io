...
gerar_dashboard(
  ...
  tam_fatias       = 12,                # Texto nas fatias do gráfico
...
processar_filho_natureza <- function(df_input, label_mod, v_referencia) {
  df_input %>%
    ...
    dplyr::summarise(
      mod_proc        = label_mod,
      desc_nat        = dplyr::first(nd_especificacao),
      frequencia      = dplyr::n(), # Quantas vezes foi pedida
    ...
    dplyr::mutate(
      ...
      p_impacto       = base::paste0(base::round((v_total_nat / v_referencia) * 100, 1), "%"),
...
# ==========================================================
# 3. CONFIGURAÇÃO E CHAMADA DA TABELA
# ==========================================================
nomes_col <- base::c(
  "Modalidade"             = "mod_proc",
...
tabela_interativa_detalhes(
  ...
  largura_detalhes_vetor     = base::c("350px", "100px", "100px", "200px", "200px", "200px"),
  pesquisa_geral             = TRUE
)
```
