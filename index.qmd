...
# ==============================================================================
# FUNÇÃO FINAL CONSOLIDADA (VERSÃO ALEX) - LIMPA E FUNCIONAL
# ==============================================================================

tabela_interativa_detalhes <- function(dados, 
                                       dados_detalhes,       # Base com os 722 itens
                                       coluna_chave,         # Chave de ligação (ex: "processo")
                                       titulo_tabela,        # Título do relatório
                                       coluna_ordenacao = NULL, # Coluna para ordenar
                                       ordem_decrescente = TRUE, # TRUE = Z-A
                                       colunas_detalhes_nomes = NULL, # Nomes amigáveis itens
                                       largura_detalhes_vetor = NULL, # Larguras px itens
  ...
  # 2. ORDENAÇÃO (R) - Feita antes da renomeação para evitar erro de objeto
  ...
  tabela <- DT::datatable(
    ...
    options = base::list(
      ...
      autoWidth = FALSE,
      scrollX = TRUE,
      columnDefs = base::list(base::list(targets = 0, className = 'details-control', width = '30px')),
      
      # INÍCIO DO BLOCO JAVASCRIPT (Sem comentários internos para não sumir a tabela)
      initComplete = DT::JS(
        base::paste0("function(settings, json) {",
  ...
  return(htmltools::tagList(htmltools::tags$h2(style=base::paste0("color:", cor_titulo, "; font-size:", tam_fonte_titulo), htmltools::tags$b(titulo_final)), tabela))
}
...
plotly::plot_ly() %>%
  ...
  plotly::layout(
    ...
    margin = base::list(t = 150, b = 40, l = 130, r = 30),
