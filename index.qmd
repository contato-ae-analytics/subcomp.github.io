...
# titulo_cor        <- "#001d3d"
titulo_cor        <- "#03045e"
titulo_tamanho    <- 14         # Ajustado para destaque (era 10)
sub_cor           <- "#000000"
sub_tamanho       <- 13         
...
minhas_larguras_catalogo <- base::c(
  # "30px",   # índice
  "80px",   # ID do item
  "360px",  # Descrição do item
  "130px",  # Elemento (Material / Serviço)
  "260px",  # Grupo
  "260px",  # Subgrupo
  "260px"   # Grupo do item
)
...
tabela_interativa(
  ...
  tam_fonte_corpo   = tamanho_eixo_x,
  tam_fonte_titulo  = titulo_tamanho,
  tam_fonte_header  = tamanho_legenda,
  
  # Cores
  cor_titulo        = "#03045e",
  cor_primaria      = cor_eixo_x,
  cor_texto_corpo   = cor_eixo_x,
