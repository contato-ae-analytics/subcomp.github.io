...
tabela_interativa <- function(dados, 
  ...
  n_col_reais <- base::ncol(dados_processados)
  ...
  novo_cont <- base::get("contador_tabelas_alex", envir = .GlobalEnv) + 1
  base::assign("contador_tabelas_alex", novo_cont, envir = .GlobalEnv)
  titulo_final <- base::paste0("Tabela ", novo_cont, ": ", titulo_tabela)
  ...
  tabela <- DT::datatable(
    ...
    escape = FALSE, # GARANTE QUE O BOTÃO DE DOWNLOAD APAREÇA
    ...
    options = base::list(
      ...
      initComplete = DT::JS(
        base::paste0("function(settings, json) {",
                     ...
                     # HOVER PROTEGIDO: Só na principal
                     "$(this.api().table().body()).on('mouseenter', 'tr', function() {",
                     "  var tr = $(this);",
