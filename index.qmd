...
#                                   nome_alvo        = NULL, # Se NULL, pega o banco todo
#                                   tam_fatias       = 11,
#                                   tam_centro_cab   = 13,
#                                   tam_centro_corpo = 9,
#                                   tam_hover_header = 14,
...
#   
#   # --- 3. AGRUPAMENTO POR MODALIDADE (HOVER RESTAURADO) ---
...
#       p_pen = base::sprintf("%.1f", (n_pendentes / n_processos) * 100),
...
#       
#       label_grafico = base::paste0("<b>", modalidade, "</b><br>", n_processos, "<br>", base::sprintf("%.1f", (n_processos / base::sum(n_processos)) * 100), "%"),
#       
...
#                                "📊 <b>Eficiência: ", p_res, "%</b> | ⏱ <b>Médio: ", base::round(tempo_medio_mod, 0), " dias</b><br>",
#                                "📦 <b>", txt_volume, ": ", n_processos, " processos</b><br>",
#                                "<span style='color:#bdc3c7'>──────────────────────────</span><br>",
#                                "✅ <b>Resolvidos:</b> ", n_resolvidos, " | ❌ <b>Pendentes:</b> ", n_pendentes, "<br>",
#                                "<span style='color:#bdc3c7'>──────────────────────────</span><br>",
#                                "💰 <b>Valor Total:</b> R$ ", v_total_txt, "<br>",
#                                "🟢 <b>Empenhado:</b> ", v_emp_txt, " | 🔴 <b>Pendente:</b> ", v_pen_txt, "</span>")
#     )
#   
#   # --- 4. MÉTRICAS DO CENTRO (EFICIÊNCIA EM NEGRITO) ---
...
#   eficiencia_final <- base::sprintf("%.1f", (res_n / total_p) * 100)
#   
#   texto_centro <- base::paste0(
#     "<span style='font-family:", fonte_padrao, ";'>",
#     "📊 <b><span style='color:", cor_eficiencia, "; font-size:", tam_centro_cab, "px;'><b>EFICIÊNCIA</b>: ", eficiencia_final, "%</span></b><br>",
#     "<span style='color:#bdc3c7'>────────────────────────</span><br>",
#     "<span style='font-size:10px;'><br></span>",
#     "<b><span style='font-size:", tam_centro_corpo, "px;'>TOTAL: ", total_p, " | R$ ", base::format(total_v, big.mark = ".", decimal.mark = ","), " | 100%</span></b><br>",
#     "<span style='font-size:4px;'><br></span>",
#     "<b><span style='color:", cor_ok, "; font-size:", tam_centro_corpo, "px;'>OK: ", res_n, " | R$ ", base::format(res_v, big.mark = ".", decimal.mark = ","), " | ", res_p, "%</span></b><br>",
#     "<span style='font-size:4px;'><br></span>",
#     "<b><span style='color:", cor_pend, "; font-size:", tam_centro_corpo, "px;'>PEND: ", pen_n, " | R$ ", base::format(pen_v, big.mark = ".", decimal.mark = ","), " | ", pen_p, "%</span></b><br>",
#     "</span>"
#   )
#   
#   # --- 5. CONSTRUÇÃO DO PLOTLY ---
...
#     plotly::layout(margin = base::list(t = 100, b = 100, l = 100, r = 100), font = base::list(family = fonte_padrao, size = tam_fatias),
#                    showlegend = FALSE, hoverlabel = base::list(bgcolor = "white", bordercolor = "black", align = "left", namelength = -1, font = base::list(family = fonte_padrao)),
...
gerar_dashboard <- function(bd_principal, 
  ...
  # --- 4. MÉTRICAS DO CENTRO (NOMES EM NEGRITO) ---
  total_p <- base::nrow(df_proc_unico); total_v <- base::sum(df_proc_unico$valor_processo, na.rm = TRUE)
  res_n <- base::sum(df_proc_unico$situacao_proc == "Resolvido"); res_v <- base::sum(df_proc_unico$valor_empenhado, na.rm = TRUE)
  res_p <- base::sprintf("%.1f", (res_n / total_p) * 100); pen_n <- total_p - res_n; pen_v <- total_v - res_v; pen_p <- base::sprintf("%.1f", (pen_n / total_p) * 100)
  ...
  texto_centro <- base::paste0(
    "<span style='font-family:", fonte_padrao, ";'>",
    "<span style='font-size:26px; color:black; font-weight:normal;'>\u2197</span><br>",
    "<b><span style='color:", cor_eficiencia, "; font-size:", tam_centro_cab, "px;'>EFICIÊNCIA: ", res_p, "%</span></b><br>",
    "<span style='color:#bdc3c7'>────────────────────────</span><br>",
    "<span style='font-size:4px;'><br></span>",
    "<span style='font-size:", tam_centro_corpo, "px;'><b>TOTAL: ", total_p, " | R$ ", base::format(total_v, big.mark = ".", decimal.mark = ","), "</b></span><br>",
    "<span style='font-size:4px;'><br></span>",
    "<span style='color:", cor_ok, "; font-size:", tam_centro_corpo, "px;'><b>EMPENHADOS:</b> ", res_n, " | ", res_p, "% | R$ ", base::format(res_v, big.mark = ".", decimal.mark = ","), "</span><br>",
    "<span style='font-size:4px;'><br></span>",
    "<span style='color:", cor_pend, "; font-size:", tam_centro_corpo, "px;'><b>PENDENTES:</b> ", pen_n, " | ", pen_p, "% | R$ ", base::format(pen_v, big.mark = ".", decimal.mark = ","), "</span>",
    "</span>"
  )
...
gerar_dashboard(
  ...
  tam_centro_cab   = 11,                # Tamanho do título EFICIÊNCIA
  tam_centro_corpo = 10,                # Tamanho das linhas TOTAL/OK/PEND
...
gerar_dashboard(
  bd_principal     = bd_principal, 
  nome_alvo        = "Rodrigo",
  tam_fatias = 15, tam_centro_cab = 11, tam_centro_corpo = 10,
  tam_hover_header = 11, tam_hover_corpo = 11,
  cor_eficiencia = "#0b132b", cor_ok = "#008000", cor_pend = "#B22222",
  largura_barra = 4
)
...
largura_col <- base::c("200px", "60px", "60px", "350px", "60px", "350px", "60px", "60px", "350px", "245px")
