...
# ==========================================================
nomes_col <- base::c(
  "Modalidade<br>Processos"       = "mod_proc",
  "Qtd."                          = "n_processos",
  "(%)"                           = "p_represent_txt", 
  "Valor<br>Total (R$)"                    = "aporte_total",
  "Proc.<br>Finalizados"      = "n_resolvidos",
  "Valor<br>Empenhado (R$)"       = "aporte_resolvido",
  "Eficiência<br>(%)"             = "p_resolvido_txt",
  "Proc.<br>Pendentes"        = "n_pendentes",
  "Valor<br>Pendente (R$)"        = "aporte_pendente",
  "Ciclo<br>Médio"                = "ciclo_txt"
)

largura_col <- base::c("185px", "50px", "50px", "350px", "90px", "350px", "80px", "90px", "350px", "170px")
