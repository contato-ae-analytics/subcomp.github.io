...
tabela_interativa_detalhes(
  ...
  titulo_tabela          = "Detalhamento de Processos",
...
minhas_colunas <- base::c(
  ...
  "Aporte Consolidado" = "aporte_total",
  "Res. (Proc)"        = "n_resolvidos",
  "Res. (Itens)"       = "itens_res_total",
  "Aporte Resolvido"   = "aporte_resolvido",
  "Eficiência (%)"     = "p_resolvido_txt",
  "Pend. (Proc)"       = "n_pendentes",
  "Pend. (Itens)"      = "itens_pen_total",
  "Aporte Pendente"    = "aporte_pendente",
  "Ciclo Médio"        = "ciclo_txt"
)

meus_nomes_detalhes <- base::c(
  "Agente (Rank)", "Proc. Totais", "Resolvidos", "Pendentes", 
  "Itens Resolvidos", "Itens Pendentes", "Aporte em Gestão", 
  "Ciclo do Agente", "Média da Modalidade", "Avaliação (Likert)", "Eficiência Individual"
)
...
tabela_interativa_detalhes(
  ...
  titulo_tabela          = "Dashboard de Alta Performance: Gestão por Processos e Aportes",
  colunas_selecionadas   = minhas_colunas,
  colunas_detalhes_nomes = meus_nomes_detalhes,
  pesquisa_geral         = TRUE,
  mostrar_filtro         = FALSE,
