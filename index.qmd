...
gerar_grafico_natureza_top <- function(bd_principal, 
  ...
  plotly::plot_ly(df_init) %>%
    ...
    plotly::layout(
      ...
      legend = base::list(orientation = 'h', x = 0, y = 1.15, font = base::list(size = tamanho_legenda, color = cor_legenda)),
...
nomes_det_final <- base::c(
  "Natureza de Despesa", "Proc. (T)", "Total (R$)", 
  "Proc. (E)", "Empenhado (R$)", "% (E)", 
  "Proc. (P)", "Pendente (R$)", "% (P)"
)
